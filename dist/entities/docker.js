...
export function checkDocker() {
    ...
    */
    try {
        ...
        throw new Error("Docker is not installed or not available in your PATH. " +
...
export function checkRailpack() {
    ...
    */
    try {
        ...
        throw new Error("Railpack is not installed or not available in your PATH. " +
            "Please install Railpack from https://railpack.io or " +
            "ensure it is properly installed and available in your system PATH.");
    }
}
export async function localDockerBuild(registryData, repositoryData) {
    /*
...
export async function localBuildWithRailpack(registryData, repositoryData) {
    /*
...
export async function buildDockerImage(registryData, repositoryData) {
    /*
...
export async function localDockerPush(repositoryData, registryData) {
    /*
