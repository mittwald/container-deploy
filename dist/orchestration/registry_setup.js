...
*/
import { generatePasswordWithSpecialChars, } from "../utils/helpers.js";
import { getProjectRegistry, createRegistry, checkProjectRegistry, } from "../entities/registry.js";
 ...
 */
export async function setupProjectRegistry(apiClient, projectId, projectShortId, timeout) {
    let registryInfo;
    ...
    if (!registry) {
        ...
        const registryServiceId = await deployServiceAs(apiClient, projectId, MW_REGISTRY_SERVICE_NAME, {
        ...
        const domainResult = await createAndWaitForDomain(apiClient, projectId, uri, registryServiceId, MW_REGISTRY_PORT_PROTOCOL, timeout);
        ...
        const createdRegistry = await createRegistry(apiClient, projectId, registryCreationPayload);
        registryInfo = {
            username,
            password,
            uri,
        ...
        registryInfo = await checkProjectRegistry(apiClient, projectId, registry);
        registryInfo.created = false;
    }
    return registryInfo;
}
//# sourceMappingURL=registry_setup.js.map